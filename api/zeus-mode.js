// Этот файл отвечает за вызовы к Gemini API, используя переменные окружения Vercel.
// Ключ API доступен через `process.env.VERCEL_GEMINI_API_KEY`.
...
export default async function (request, response) {
  ...
  try {
    // Получаем весь payload, отправленный с фронтенда.
